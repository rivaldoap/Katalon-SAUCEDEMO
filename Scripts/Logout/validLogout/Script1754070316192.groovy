...
//LOGOUT
WebUI.waitForElementVisible(findTestObject("Object Repository/Home Page/sideMenu(burgerbars)"), 2)
WebUI.click(findTestObject("Object Repository/Home Page/sideMenu(burgerbars)"))
WebUI.click(findTestObject("Object Repository/Home Page/btnLogout"))