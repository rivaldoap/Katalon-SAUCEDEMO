...
//Sort Product Z to A
WebUI.click(findTestObject("Object Repository/Home Page/sortNameZtoA"))

//Sort Product Low to High
WebUI.click(findTestObject("Object Repository/Home Page/sortLowToHigh"))

//Sort Product High to Low
WebUI.click(findTestObject("Object Repository/Home Page/sortHighToLow"))